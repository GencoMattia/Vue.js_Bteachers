                ...
                <div class="row d-flex justify-content-between mb-3">
                    <div class="card m-0">
                        <div class="container-card bg-blue-box">
                            ...
                            <p class="card-description">Trova insegnanti qualificati per qualsiasi materia o abilità che vuoi imparare.</p>
                        </div>
                    </div>
                    <div class="card m-0">
                        <div class="container-card bg-blue-box">
                            ...
                            <p class="card-description">Comunica con gli insegnanti e pianifica facilmente le tue lezioni.</p>
                        </div>
                    </div>
                    <div class="card m-0">
                        <div class="container-card bg-blue-box">
                            ...
                            <p class="card-description">Lascia una valutazione per aiutare altri studenti a trovare gli insegnanti migliori.</p>
                        </div>
                    </div>
                </div>
            </div>
